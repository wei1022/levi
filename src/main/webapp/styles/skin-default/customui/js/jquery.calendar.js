            ...
            render: function(renderCalback) {
                ...
                var onResize = function() {
                    ...
                    if(!options.showAlways){
                        ...
                        var tempTop = elPos.top + el.outerHeight() + options.calendarOffset.y;
                        var tempLeft = elPos.left + options.calendarOffset.x;
                        if ((tempTop+calendar.outerHeight()) > windowHeight) {
                            tempTop = elPos.top - calendar.outerHeight() - options.calendarOffset.y;
                        }
                        if ((tempLeft+calendar.outerWidth()) > windowWidth) {
                            tempLeft = elPos.left - calendar.outerWidth() - + options.calendarOffset.x;
                        }
                        calendar.css(
                        {
/*                            top: (elPos.top + el.outerHeight() + options.calendarOffset.y) + 'px',
                    ...
                    // for show
                        ...
                        calendar.css(
                        {
//                            top: (elPos.top + options.calendarOffset.y) + 'px',
//                            left: (elPos.left + options.calendarOffset.x) + 'px'
                            top: '0px',
                            left: '0px'
                        });
...
//                    calendar.css(
//                    {
//                        top: (elPos.top + outerHeight + options.calendarOffset.y) + 'px',
//                        left: (elPos.left + options.calendarOffset.x) + 'px'
//                    });
                };
